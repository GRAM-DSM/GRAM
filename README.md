...
- 동아리 시간에 비속어를 사용하지 않습니다.
  - 3번 사용할 때마다 회비 1000원을 냅니다.
- 동아리 시간에 지각하지 않습니다.
...
- 좀 더 활기찬 동아리를 위해 동아리시간 전과 쉬는시간에 1인당 1곡씩 Slack의 `music` 채널에  `@다은`으로 음악대장을 언급하고 신청곡을 올립니다.
...
- 회고의 날인 금요일에 동아리를 빠지는 동아리원은 슬랙에 자신의 회고를 정리하여 `retrospective` 에 올리도록 합니다.
- Notion
  - 프로젝트 문서
  - 동아리 일정
  - 라이트닝 토크 발표자료 & 질문
...
- 라이트닝 토크
    - 매주 수요일 8교시마다 진행합니다.
    - 한 주마다 발표자들을 바꿔가며 발표를 진행합니다. 
    - 규칙
      - 전날에 주제를 선정해 슬랙 gram-talk채널에 올립니다.
...
- 회고
  - 금요일 8시부터 정해진 틀없이 간단하게 일주일 동안의 회고를 진행합니다.
